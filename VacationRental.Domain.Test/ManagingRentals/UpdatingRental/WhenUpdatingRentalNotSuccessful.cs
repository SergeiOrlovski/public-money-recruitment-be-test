...
public class WhenUpdatingRentalNotSuccessful : BaseRentalsServiceFixture
{
    [Fact]
    public void ReturnsExpectedErrorResult()
    {
        ...
        WithUpdatingRentalResult(false, existingRental);
        ...
        result.Error.Should().Be("Update rental unsuccessful");
    }
}